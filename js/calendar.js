...
//Generating sunburst through params & appending data
	chart.sunburst = function (outer, inner, rings, segments, colors) {
...
//Drawing sunburst
	chart.sunburst(chart.outer, chart.inner, chart.rings, chart.segments, chart.colors);
};

var calendar = new Calendar(300, 50, {top: 40, right: 40, bottom: 40, left: 40}, ['#1E0B7F', '#231355', '#2E1562', '#410D65', '#550D38', '#533136', '#544C35', '#52563A', '#445A38', '#285833', '#1C4633', '#112938', '#1C4C55', '#1E5070', '#1B3C72'], 16, 15);
